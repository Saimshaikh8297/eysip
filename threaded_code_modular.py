...
with open("/Users/siddharth/Desktop/EYSIP/NEW VIDS & RESULTS/results_perfect.csv", 'r') as csvfile:
...
path_to_circle_image = perfect_values[0][1]
path_to_thick_line = perfect_values[0][2]
perfect_values[0][3] = ast.literal_eval(perfect_values[0][3])
(x_first, y_first) = perfect_values[0][3][0]
print(path_to_thick_line)

img_plot = cv2.imread(path_to_thick_line)
img_with_circles = cv2.imread(path_to_circle_image)
    ...
    class compute_frame(threading.Thread):
        ...
        def filter_top_of_robot(self, frame):
            ...
            if contours.__len__() != 0:
                ...
                if flag_first==True and (x,y)!=(0,0):
                    print("adj")
                    print(x,y)
        ...
        def physical_marker(self, frame, flag_pm, li_pm, count_pm):
        ...
        def deleteframes(self, team_id, file_name, contours, flag=True):
            ...
            while (cap.isOpened()):
                ...
                if ret == True and (tlx, tly, trix, triy, blx, bly, brx, bry) != (0, 0, 0, 0, 0, 0, 0, 0):
                    ...
                    flag_pm,li_pm,count_pm = self.physical_marker(image,flag_pm=flag_pm,li_pm=li_pm,count_pm=count_pm)
            ...
            # print(name2)
            # print("i am out of delete_frames")
            print(pm_framecounts)
            print(cnt_pm)
            print(fps)
            # tmarker1=pm_framecounts[0]/fps
            # tmarker2=pm_framecounts[1]/fps
