...
def kaze_match():
    ...
    im1 = cv2.imread("sample6.jpg")
    im2 = cv2.imread("sample4.jpg")
    ...
    im3brisk = cv2.drawMatchesKnn(im1, briskkps1, im2, briskkps2, goodbrisk[1:20], None, flags=2)
    cv2.imshow("BRISK matching", im3brisk)
    goodbrisk = np.asarray(goodbrisk)
    print(goodbrisk.shape)
