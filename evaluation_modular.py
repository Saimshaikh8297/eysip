...
perfect_values= []
with open("perfect_results.csv", 'r') as csvfile:
...
path_to_perfect_image = perfect_values[0][0]
perfect_values[0][4] = ast.literal_eval(perfect_values[0][4])
feature_list = perfect_values[0][4]
coordinates = ast.literal_eval(perfect_values[0][3])
